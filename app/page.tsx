  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative border-b">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6 py-10 text-white">
          <div className="mx-auto inline-grid max-w-full justify-items-center">
            <h1 className="col-start-1 row-start-1 justify-self-center text-center font-heading text-4xl font-bold tracking-tight drop-shadow-md md:text-5xl md:whitespace-nowrap lg:text-6xl">
              Never lose your book again
            </h1>

            <div className="col-start-1 row-start-2 mt-8 w-0 min-w-full">
      ...
      <section className="border-b px-6 py-16 md:py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mx-auto mt-10 max-w-4xl">
            <YouTubeEmbed
              videoUrl="https://www.youtube.com/watch?v=9Em3ioCI5Jw"
      ...
      <footer className="border-t bg-muted/30 px-6 py-10">
        <div className="mx-auto flex max-w-5xl flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          <a
            ...
            aria-label="Trace-That-Tome home"
          >
            <img
              src="/assets/logos/Logo-transparent.png"
              alt="Trace-That-Tome logo"
          ...
          <nav className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
            <a className="text-muted-foreground underline-offset-4 hover:text-foreground hover:underline" href="#order">
              Order
            </a>
            <a className="text-muted-foreground underline-offset-4 hover:text-foreground hover:underline" href="/reviews">
              Reviews
            </a>
          </nav>
        </div>
        <div className="mx-auto mt-6 max-w-5xl text-xs text-muted-foreground">
          © {new Date().getFullYear()} Trace-That-Tome. School project site.
        </div>
      </footer>
    </main>
  );
